...
// volatile, pueden ser cambiadas por una interrupcion
...
/*lista de comandos
const char cmd1[] = {"set MIC2_ledred 1"}; // Comando para encender led rojo
const char cmd2[] = {"set MIC2_ledred 0"}; // Comando para apagar led rojo
const char cmd3[] = {"set MIC2_ledgreen 1"}; // Comando para encender led verde
const char cmd4[] = {"set MIC2_ledgreen 0"}; // Comando para apagar led verde
const char cmd5[] = {"print MIC2_data"}; // Comando para iniciar la impresión de contador
const char cmd6[] = {"stop MIC2_data"}; // Comando para detener la impresión de contador
 */
//Comandos prueba
const char cmd1[] = {"1"};
const char cmd2[] = {"2"};
...
void uart_config(unsigned int baud) {
    ...
    U1STAbits.URXISEL = 0; // Salta la interrupción cuando hay uno o mas caracteres en el buffer.
...
int main(void) {
    ...
    INTCON1bits.NSTDIS = 0; //Interrupciones anidads habilitadas.
    SRbits.IPL = 0; //Todas las interrupciones están habilitadas.
...
void __attribute__((__interrupt__, no_auto_psv)) _U1RXInterrupt(void) {
    ...
    IFS0bits.U1RXIF = 0; // Reset Rx Interrupt, para que no se quede en bucle en la interrupción.
...
{
    IEC0bits.U1TXIE = 0; // Disable UART1 Tx Interrupt, para que no vuelva a entrar por seguridad.
